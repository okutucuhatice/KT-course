...
Die Entropie meines Textes zeigt, dass einige Buchstaben häufiger vorkommen als andere. 
Zum Beispiel treten Vokale wie „e“ oder „a“ öfter auf. 
Der Text ist daher nicht völlig zufällig und enthält eine gewisse Redundanz.
---

## Konsolenausgabe

```
Anzahl Bierdeckel R (Bezeichnungsraum) [Standard 30]: 
Bierdeckel-Telegraf: R = 3 Deckel (Bezeichnungsraum), B = Brauereien (Basis)
n = R/B Stellen,  V = B^n = Signalvorrat,  G = log2(V) = Entscheidungsgehalt (H = G in bit)
============================================================

   B |  n=R/B |        V = B^n | G = log2(V) [bit]
------------------------------------------
   1 |      3 |              1 |         0.00
   3 |      1 |              3 |         1.58

============================================================
Optimum: B = 3  (n = 1 Stellen)  =>  V_max = 3,  G_max = 1.58 bit (H = G)
Theorie: B = e ≈ 2.72 ist optimal; bei ganzzahligem B oft B = 2 oder B = 3.
```
...
```
Analyze the file:  C:\Users\hatice kübra\KT-course\lab_suite\labs\01_02_Informationstheorie\sidedata/sampletext.txt
